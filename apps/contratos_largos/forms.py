...
class Select1(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['lugar'].queryset = forms.ChoiceField(choices=no_lugar,widget=forms.Select(attrs={'class':'form-control'}))
    ...
    class Meta:
        ...
        widgets={
            ...
            'nombre_completo_actividad': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '0-255 caracteres'}),
...
class modal(forms.ModelForm):
    class Meta:
        ...
        widgets={
            'monto_faltante': forms.NumberInput(attrs={'class': 'form-.input', 'placeholder': '1-10 digitos','readonly':'readonly'}),
            'monto_total': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '1-10 digitos','readonly':'readonly'}),
            'monto_depositado': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': '1-10 digitos','readonly':'readonly'}),
...
class FiltroFechas(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
             'fecha_inicial': forms.DateInput(format=('%Y-%m-%d', '%m/%d/%Y', '%m/%d/%y',), attrs={'class': 'form-control entrada', 'placeholder': 'Seleccione la fecha Correcta'}),
             'fecha_final': forms.DateInput(format=('%Y-%m-%d', '%m/%d/%Y', '%m/%d/%y',), attrs={'class': 'form-control salida', 'placeholder': 'Seleccione la fecha Correcta'})
        }
